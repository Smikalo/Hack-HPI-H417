...
def handle_sae_message(sae_message_bytes, preserve_frame=False, output_file=None):
    ...
    if output_file is not None:
        ...
        if 'detections' in d:
            print("Number of cars: ", len(d['detections']))
        else:
            print("Number of cars: 0")
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('-f', '--preserve-frame', action='store_true',
                            help='Do not remove frame data (WARNING: large output!)')
